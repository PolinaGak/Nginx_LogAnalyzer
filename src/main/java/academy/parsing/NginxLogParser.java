...
public class NginxLogParser {
  private static final Logger logger =
      LogManager.getLogger(NginxLogParser.class);
  ...
  public Optional<LogEntry> parse(String line) {
    ...
    try {
      ...
      long responseSizeBytes =
          "-".equals(bodySizeStr) ? 0L : Long.parseLong(bodySizeStr);
      ...
      LogEntry entry =
          new LogEntry(timestamp, remoteAddr, statusCode, responseSizeBytes,
                       resource, protocol, referer, userAgent);
